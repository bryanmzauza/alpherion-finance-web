...
| 17 | [Fonte das cotações da B3: licença antes de publicar](ADR-017-fonte-das-cotacoes.md) — **proposta**, aguarda a B3 e a decisão do Bryan | Publicar o COTAHIST sem licença; provedor licenciado como substituto da licença | Termos do site da B3 vedam uso comercial sem autorização escrita e a Política de Consumo 2026 exige licença (Atraso Snapshot R$ 320/mês + Produtizador); CoinGecko Demo também não é comercial. Preço fica atrás de feature flag até a licença; o resto (CVM, Tesouro, BCB) publica |
